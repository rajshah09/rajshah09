...
new_msg_time = 25                # TTime for a new message (in seconds)
send_msg_time = 5               # Time for sending a message (in seconds)
country_code = 91               # Set your country code
action_time = 25                 # Set time for button click action
...
# Encode Message Text
with open('/home/rextron/PythonPractice/WhatsApp_Sender/message.txt', 'r') as file:
    msg = file.read()
...
with open('/home/rextron/PythonPractice/WhatsApp_Sender/numbers.txt', 'r') as file:
